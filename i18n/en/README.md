...
3. Click the navigation bar on the right to view all conversation records
4. Click any message to quickly navigate to that position

### Keyboard Shortcuts

- `Alt + N`: Toggle navigation bar visibility
- `Alt + S`: Focus on the search box

### Search Function

Enter keywords in the search box of the navigation bar to filter conversation content in real time.
...
1. Ensure you are on the ChatGPT page
